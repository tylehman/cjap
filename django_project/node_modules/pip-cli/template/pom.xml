<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<artifactId>pip-{name}</artifactId>
	...
	<build>
		...
		<plugins>
			...
			<plugin>
				...
				<configuration>
					<webApp>
						<contextPath>/pip{name}</contextPath>
					</webApp>
				</configuration>
			</plugin>
			<plugin>
                 ...
                 <version>2.6</version>  
                 <configuration>
                     <warSourceExcludes>upload/**, node_modules/</warSourceExcludes>
                 </configuration>  
            </plugin>
			<plugin>
	...
	<dependencies>
		<dependency>
			...
			<artifactId>pip-graphDb</artifactId>
			<version>${project.version}</version>
		</dependency>
		<dependency>
			<groupId>${project.groupId}</groupId>
			<artifactId>pip-commonmodel</artifactId>
			<version>${project.version}</version>
			<!--<exclusions>-->
				<!--<exclusion>-->
				   <!--<groupId>rt</groupId>-->
		...
		<dependency>
			<groupId>${project.groupId}</groupId>
			<artifactId>pip-commonLucene</artifactId>
			<version>${project.version}</version>
		</dependency>
		<dependency>
			<groupId>${project.groupId}</groupId>
			<artifactId>pip-commonHadoop</artifactId>
			<version>${project.version}</version>
		</dependency>
		<dependency>
